...
export const listings: Listing[] = [
  {
    ...
    rating: 4.8,
    reviewCount: 24,
    owner: { name: "Khalid Benali", phone: "0661234567", avatar: "KB" },
    bedrooms: 2,
    bathrooms: 1,
    area: 85,
    available: true,
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 18,
    owner: { name: "Fatima Ziani", phone: "0662345678", avatar: "FZ" },
    bedrooms: 1,
    bathrooms: 1,
    area: 45,
    available: true,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 31,
    owner: { name: "Hassan Filali", phone: "0663456789", avatar: "HF" },
    bedrooms: 4,
    bathrooms: 3,
    area: 280,
    available: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 15,
    owner: { name: "Amina Sqalli", phone: "0664567890", avatar: "AS" },
    bedrooms: 3,
    bathrooms: 2,
    area: 200,
    available: true,
  },
  {
    ...
    rating: 4.6,
    reviewCount: 42,
    owner: { name: "Youssef Tazi", phone: "0665678901", avatar: "YT" },
    brand: "Dacia",
    model: "Logan",
    year: 2022,
    seats: 5,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 28,
    owner: { name: "Rachid Moulay", phone: "0666789012", avatar: "RM" },
    brand: "Hyundai",
    model: "Tucson",
    year: 2023,
    seats: 5,
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 19,
    owner: { name: "Sara Benkirane", phone: "0667890123", avatar: "SB" },
    bedrooms: 3,
    bathrooms: 2,
    area: 120,
    available: true,
  },
  {
    ...
    rating: 4.4,
    reviewCount: 56,
    owner: { name: "Omar Chraibi", phone: "0668901234", avatar: "OC" },
    brand: "Renault",
    model: "Clio",
    year: 2021,
    seats: 5,
  ...
  // ─── Casablanca ───────────────────────────────────────────────
  {
    ...
    rating: 4.9,
    reviewCount: 47,
    owner: { name: "Nadia Alaoui", phone: "0661000001", avatar: "NA" },
    bedrooms: 2,
    bathrooms: 2,
    area: 95,
    available: true,
  ...
  },
  {
    ...
    rating: 5.0,
    reviewCount: 12,
    owner: { name: "Mehdi Fassi", phone: "0661000002", avatar: "MF" },
    bedrooms: 5,
    bathrooms: 4,
    area: 450,
    available: true,
  },
  {
    ...
    rating: 4.8,
    reviewCount: 33,
    owner: { name: "Karim Benjelloun", phone: "0661000003", avatar: "KB" },
    brand: "BMW",
    model: "Série 3",
    year: 2023,
    seats: 5,
  ...
  // ─── Marrakech ────────────────────────────────────────────────
  {
    ...
    rating: 4.9,
    reviewCount: 89,
    owner: { name: "Aicha Senhaji", phone: "0661000004", avatar: "AS" },
    bedrooms: 4,
    bathrooms: 4,
    area: 320,
    available: true,
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 34,
    owner: { name: "Yassine Ouali", phone: "0661000005", avatar: "YO" },
    bedrooms: 2,
    bathrooms: 1,
    area: 80,
    available: true,
  ...
  // ─── Agadir ───────────────────────────────────────────────────
  {
    ...
    rating: 4.7,
    reviewCount: 61,
    owner: { name: "Houssam Kadiri", phone: "0661000006", avatar: "HK" },
    bedrooms: 1,
    bathrooms: 1,
    area: 42,
    available: true,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 25,
    owner: { name: "Driss Ouarzazi", phone: "0661000007", avatar: "DO" },
    brand: "Range Rover",
    model: "Evoque",
    year: 2022,
    seats: 5,
  ...
  // ─── Tanger ───────────────────────────────────────────────────
  {
    ...
    rating: 4.8,
    reviewCount: 22,
    owner: { name: "Zineb Laroussi", phone: "0661000008", avatar: "ZL" },
    bedrooms: 3,
    bathrooms: 2,
    area: 140,
    available: true,
  ...
  // ─── Rabat ────────────────────────────────────────────────────
  {
    ...
    rating: 4.6,
    reviewCount: 38,
    owner: { name: "Mostafa Alami", phone: "0661000009", avatar: "MA" },
    bedrooms: 3,
    bathrooms: 2,
    area: 110,
    available: true,
  ...
  // ─── Fès ──────────────────────────────────────────────────────
  {
    ...
    rating: 4.9,
    reviewCount: 54,
    owner: { name: "Abdelkader Sqalli", phone: "0661000010", avatar: "AK" },
    bedrooms: 3,
    bathrooms: 3,
    area: 250,
    available: true,
  ...
  // ─── Essaouira ───────────────────────────────────────────────
  {
    ...
    rating: 4.7,
    reviewCount: 29,
    owner: { name: "Leila Chraibi", phone: "0661000011", avatar: "LC" },
    bedrooms: 2,
    bathrooms: 1,
    area: 70,
    available: true,
  ...
  // ─── Dakhla ──────────────────────────────────────────────────
  {
    ...
    rating: 4.8,
    reviewCount: 17,
    owner: { name: "Ahmed Sahrawi", phone: "0661000012", avatar: "AS" },
    bedrooms: 3,
    bathrooms: 2,
    area: 180,
    available: true,
...
export const activities: Activity[] = [
  {
    ...
    rating: 4.8,
    reviewCount: 64,
    owner: { name: "Karim Adventures", phone: "0661111001", avatar: "KA" },
    minPersons: 1,
    maxPersons: 8,
    available: true,
    deal: 10,
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 38,
    owner: { name: "Saidia Watersports", phone: "0661111002", avatar: "SW" },
    minPersons: 1,
    maxPersons: 2,
    available: true,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 52,
    owner: { name: "Zegzel Guides", phone: "0661111005", avatar: "ZG" },
    minPersons: 2,
    maxPersons: 15,
    available: true,
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 41,
    owner: { name: "Oriental Trekking", phone: "0661111006", avatar: "OT" },
    minPersons: 2,
    maxPersons: 12,
    available: true,
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 95,
    owner: { name: "Saidia Beach Club", phone: "0661111008", avatar: "SB" },
    minPersons: 2,
    maxPersons: 20,
    available: true,
    idealFor: ["family"],
  },
  {
    ...
    rating: 5.0,
    reviewCount: 28,
    owner: { name: "Desert Oriental Tours", phone: "0661111009", avatar: "DO" },
    minPersons: 2,
    maxPersons: 10,
    available: true,
  ...
  // ─── Activités nationales ─────────────────────────────────────
  {
    ...
    rating: 4.9,
    reviewCount: 112,
    owner: { name: "Marrakech Découverte", phone: "0661200001", avatar: "MD" },
    minPersons: 1,
    maxPersons: 12,
    available: true,
  ...
  },
  {
    ...
    rating: 5.0,
    reviewCount: 76,
    owner: { name: "Dakhla Kite Center", phone: "0661200002", avatar: "DK" },
    minPersons: 1,
    maxPersons: 6,
    available: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 203,
    owner: { name: "Rick's Café Casablanca", phone: "0661200003", avatar: "RC" },
    minPersons: 2,
    maxPersons: 20,
    available: true,
  ...
  },
  {
    ...
    rating: 5.0,
    reviewCount: 89,
    owner: { name: "Sahara Dream Tours", phone: "0661200004", avatar: "SD" },
    minPersons: 1,
    maxPersons: 8,
    available: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 145,
    owner: { name: "Taghazout Surf School", phone: "0661200005", avatar: "TS" },
    minPersons: 1,
    maxPersons: 10,
    available: true,
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 67,
    owner: { name: "Dar Roumana Restaurant", phone: "0661200006", avatar: "DR" },
    minPersons: 2,
    maxPersons: 16,
    available: true,
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 93,
    owner: { name: "Tanger Explorer", phone: "0661200007", avatar: "TE" },
    minPersons: 1,
    maxPersons: 15,
    available: true,
    idealFor: ["family", "couple", "solo", "group"],
